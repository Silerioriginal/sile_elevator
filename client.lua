...
AddEventHandler('sile_elevator:goToFloor', function(data)
...
AddEventHandler('sile_elevator:noAccess', function()
    lib.notify({
        title = 'Nessun accesso',
        description = 'Mi spiace zi ma non ce puoi annà',
        type = 'error'
    })
end)

AddEventHandler('sile_elevator:openMenu', function(data)
